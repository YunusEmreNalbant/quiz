    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="GET" action="">
                <div class="form-row">
                    <div class="col-md-2">
                        <input type="text" name="title" placeholder="Quiz Adı" value="{{request()->get('title')}}"
                               class="form-control">
                    </div>
                    <div class="col-md-2">
            ...
            {{$quizzes->withQueryString()->links()}} <!-- withQueryString:  sayfalamaya benim sorgumuda de ekle-->
        </div>
    </div>
</x-app-layout>
