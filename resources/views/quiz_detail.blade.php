        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-4">
                        ...
                        @if($quiz->my_result)
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="float-right">
                                    <span
                                        class="badge badge-warning badge-pill">{{$quiz->my_result->correct}} Doğru </span>
                                    <span
                                        class="badge badge-danger badge-pill">{{$quiz->my_result->wrong}} Yanlış </span>
                                </div>
                    ...
                    @if(count($quiz->topFive) > 0)
                        <div class="card mt-3">
                            <div class="card-body">
                                <h5 class="card-title">İlk 5</h5>
                                <ul class="list-group">
